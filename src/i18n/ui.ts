...
export const UI: Record<Locale, UiStrings> = {
  ...
  zh: {
    skipToContent: '跳到内容',
    requestOemQuote: '索取 OEM 报价',
    whatsapp: 'WhatsApp',
    email: '邮箱',
    relationship:
      'Dingwei Battery 提供 OEM 与贴牌电池方案，由晋州成光电源有限公司（2002 年成立）制造。',
    founded: '{year} 年成立',
    exportPorts: '出口港口',
    certsLine: '本站引用的认证由 {name} 持有：{certs}。',
    legalLine:
      '© {year} {brand}。{legalName}。所有规格仅供参考，下单前请与制造商确认最终数值。',
    explore: '了解 {name}',
    oemProcessTitle: 'OEM 流程',
    oemProcessLead: '从首次咨询到发货的七个步骤。',
    batteryLabel: '电池',
    viewSpec: '查看规格',
    breadcrumb: '面包屑导航',
    nav: {
    ...
    footer: {
      ...
      truckBatteries: '卡车电池',
      privateLabel: '贴牌',
      heavyDutyBatteries: '重载电池',
      resources: '资源',
      whatIsOem: '什么是 OEM 电池？',
      oemVsOdm: 'OEM vs ODM vs 贴牌',
      choosingManufacturer: '如何选择制造商',
      supplierChecklist: '供应商核对清单',
      specGuide: '规格指南',
      batteryFinder: '电池选型工具',
      techDocs: '技术文档',
      contact: '联系',
      requestQuote: '索取 OEM 报价',
      manufacturer: '制造商',
      ...
      warranty: '质保政策',
      returnRefund: '退货与退款',
      shippingCompliance: '运输与合规',
    },
    statsbar: {
      factoryArea: '厂区面积',
      productionLines: '产线数量',
      exportCountries: '出口国家',
      qualitySystem: '汽车质量体系',
    },
    cta: {
      defaultTitle: '启动您的 OEM 电池项目',
      defaultText:
        '告诉我们您的规格、目标市场与年需求量，我们将为您准备 OEM 或贴牌方案供评估。',
    },
  },
};
